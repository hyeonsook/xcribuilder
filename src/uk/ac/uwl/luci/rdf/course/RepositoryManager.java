// Decompiled by DJ v3.12.12.96 Copyright 2011 Atanas Neshkov  Date: 27/10/2012 15:36:40
...
public class RepositoryManager
{
    ...
    public static void add(String filePath, String superContextStr)
    {
        ...
        try {
            ...
            luciRepository = new HTTPRepository("http://luci.uwl.ac.uk/openrdf-sesame", "luci");
    ...
    public static void remove(String filePath, String superContextStr)
    {
        ...
        try {
            ...
            Repository luciRepository = new HTTPRepository("http://luci.uwl.ac.uk/openrdf-sesame", "luci");
            luciRepository.initialize();
            con = luciRepository.getConnection();
    ...
    private static final String REPOSITORY_ID = "luci";
}
